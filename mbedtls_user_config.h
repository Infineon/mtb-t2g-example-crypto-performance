 ...
 *
 *  mbedtls_platform_gmtime_r() is an abstraction in platform_util.h that
 * behaves similarly to the gmtime_r() function from the C standard. Refer to
 * the documentation for mbedtls_platform_gmtime_r() for more information.
 *
 *  It is possible to configure an implementation for
 ...
 *
 *  MBEDTLS_PLATFORM_SNPRINTF_ALT is required on Windows;
 * it will be enabled automatically by check_config.h
 *
 *  MBEDTLS_PLATFORM_XXX_ALT cannot be defined at the same time as
 ...
 *
 *    Even if this option is disabled, both client and server are aware
 ...
 *           MBEDTLS_SSL_PROTO_DTLS
 *
 *  Disabling this is often a security risk!
 ...
 *
 *  See also our Knowledge Base article about porting to a new
 * environment:
 ...
 *      MBEDTLS_TLS_PSK_WITH_RC4_128_SHA
 *
 *    ARC4 is considered a weak cipher and its use constitutes a
 ...
 *
 *  The PSA Crypto API is still beta status. While you're welcome to
 ...
 *
 *  If this option is disabled, mbedtls_ssl_get_peer_cert() is still
 *       defined, but always returns \c NULL.
 *
 *  This option has no influence on the protection against the
...
/**
 *      Enable alternate crypto implementations to use the hardware
